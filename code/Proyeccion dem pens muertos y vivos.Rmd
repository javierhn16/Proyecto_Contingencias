...
# Cargar librerias y df a utilizar
```{r}
# Instalamos y cargamos el paquete rmdformats
...
libraries <- c("readxl", "readr", "ggplot2", "tidyverse", "dplyr", "plotly")

# for que verifique que esten descargadas
