...
```{r}
tabla_latex_primas_unicas_hombres <- xtable(tabla_distinta_tasa_hombres)

print(tabla_latex_primas_unicas_hombres)
```

```{r}
tabla_latex_primas_unicas_hombres <- xtable(tabla_distinta_tasa_mujeres)
